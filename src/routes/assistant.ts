...
- บริบทด้านล่างมีข้อมูลจริงของผู้ใช้ครบทุกส่วนของแอป (ไดอารี, สถิติ, ก้าวเดิน, เส้นทาง GPS,
  เพลง, แกลเลอรี, รายชื่อเพื่อน+streak, สถานะแชร์ตำแหน่ง, ตำแหน่งเพื่อนที่แชร์อยู่, แชทที่คุยกับเพื่อน)
  วิเคราะห์และใช้ข้อมูลพวกนี้ตอบคำถามได้เต็มที่ทุกหมวดตามที่ผู้ใช้ถาม ไม่ต้องกั้นตัวเองว่าตอบได้แค่
  เรื่องแคลอรีเท่านั้น — ถ้าถามเรื่องเพื่อน ตำแหน่ง หรือแชท ก็ดึงจากบริบทมาตอบตรงๆ ได้เลย`;
